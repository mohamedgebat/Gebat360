...
export const AppStateProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Purge automatique des données obsolètes enregistrées dans le localStorage du navigateur (DATA_VERSION v221)
  if (typeof window !== 'undefined') {
    const DATA_VERSION = 'v2026_08_29_proposition_1_auto_gantt_target_v221';
