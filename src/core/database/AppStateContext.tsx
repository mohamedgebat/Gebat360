...
export const AppStateProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Purge automatique des données obsolètes enregistrées dans le localStorage du navigateur (DATA_VERSION v195)
  if (typeof window !== 'undefined') {
    const DATA_VERSION = 'v2026_08_28_sticky_fixed_sidebar_top0_v195';
