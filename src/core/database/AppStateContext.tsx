...
export const AppStateProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Purge automatique des données obsolètes enregistrées dans le localStorage du navigateur (DATA_VERSION v219)
  if (typeof window !== 'undefined') {
    const DATA_VERSION = 'v2026_08_29_fixed_selectedwbsCode_reference_error_v219';
