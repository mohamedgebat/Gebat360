...
export const INITIAL_WBS: Record<string, WBSNode[]> = {
  ...
  'CIV-2026-ST-BING-001': REAL_DS_BINGERVILLE_ACTIVITIES,
  'CIV-2026-ST-SONG-002': REAL_DS_SONGON_ACTIVITIES,
  'BINGERVILLE-ST': REAL_DS_BINGERVILLE_ACTIVITIES,
  'SONGON-ST': REAL_DS_SONGON_ACTIVITIES,
};
